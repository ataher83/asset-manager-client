...
const EmployeeSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optionally save date of birth to your backend or Firebase database
      // await saveUserProfile({ name, image_url, dateOfBirth });
      navigate('/');
    ...
    <div className='flex justify-center items-center min-h-screen bg-blue-100'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-blue-300 text-gray-900'>
        ...
        <div className='flex items-center pt-4 space-x-1'>
          ...
          <p className='px-3 text-blue-700 font-semibold'>OR</p>
          <div className='flex-1 h-px sm:w-16 bg-gray-700'></div>
        </div>
        <button
          disabled={loading}
          onClick={handleGoogleSignIn}
          className='disabled:cursor-not-allowed flex justify-center items-center space-x-2 border-2 m-3 p-2 border-blue-700 rounded-lg cursor-pointer'
        >
          <FcGoogle size={32} />
